...
const OBRAS_SOCIALES_REGLAS: readonly ObraSocialCsvRow[] = [
    ...
    { id: 352, nombre: 'NOBIS SA - COD.352', requiereCoseguro: 'N', estado: 'A', fechaEstado: new Date() },
    { id: 358, nombre: 'PREVENCION SALUD', requiereCoseguro: 'N', estado: 'A', fechaEstado: new Date() },
